...
public class DefaultMethodExample2 {
    ...
    //static Comparator<Student> studentComparator = Comparator.nullsFirst(nameComparator);
    static Comparator<Student> studentComparator = Comparator.nullsLast(nameComparator);
    ...
    public static void comparatorWithNullValues(){
        List<Student> studentList = StudentDataBase.getAllStudents();
        studentList.sort(studentComparator);
        System.out.println("Comparator With null values");
        studentList.forEach(studentConsumer);
    }
